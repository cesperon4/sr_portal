...
export const initialPoliceComplaintColumns = {
  OBJECTID: false,
  Location: false,
  Address: true,
  ...
  CitizenComplaint: true,
  CitizenSex: true,
  CitizenRace: true,
  CitizenAge: true,
  AllegationType: false,
  Allegation: true,
  Finding: false,
  Block: false,
  StreetName: true,
  StreetType: false,
  StreetDirection: false,
  City: true,
  State: true,
  Zipcode: true,
  Count_: false,
...
export const initialPolicePursuitColumns = {
  OBJECTID: false,
  IncidentNumber: false,
  UniqueKey: false,
  CaseNumber: false,
  ...
  DamageOther: false,
  DamagePolice: false,
  DamageParkedVehicle: false,
  DamageProperty: false,
  DamageSuspectVehicle: false,
  Distance: true,
  Reason: true,
  TimeOfDay: false,
  VehicleType: true,
  ...
  OffenderSex: true,
  OffenderRace: true,
  CopterAvailable: false,
  CopterUsed: false,
  DUIArrest: true,
  StopDeviceUsed: false,
  StopDevice: false,
  JUSTIFIED: false,
  FollowPolicy: false,
  ...
  LocationBegan: false,
  LocationEnded: false,
  InCarCamAvailable: false,
  InCarCamUsed: false,
  TotalTimeMinutes: true,
  InfluencingFactor: true,
  VIOLATION: true,
  AbortedBy: false,
  ConcludedBy: true,
  DamageType: false,
  InjuryType: false,
  InitiatedByAgency: false,
  ConcludedByAgency: false,
  LiabilityClaim: false,
  AssociatedOfficerCount: false,
  OfficerCondition: false,
  Count_: false,
  F_first_match: false,
  OBJECTID_1: false,
};

export const initialPoliceForceColumns = {
  OBJECTID: false,
  Location: false,
  Address: true,
  IncidentNumber: false,
  ...
  SuspectInjured: true,
  SuspectHospitalized: true,
  YearsOfService: false,
  OfficerInjured: true,
  OfficerHospitalized: false,
  UseOfForceType: true,
  UseOfForceTypeScale: true,
  Disposition: false,
  Block: false,
  StreetName: true,
  StreetType: false,
