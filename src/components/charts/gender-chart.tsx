  ...
  return (
    <div className="flex justify-center gap-8">
      ...
      <div className="flex flex-col p-4 bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-200 min-w-[250px]">
        {/* Card Title */}
        <h2 className="text-sm font-medium text-gray-600 mb-3">Arrests by Gender</h2>
        ...
        <div className="overflow-x-auto">
          <Table className="w-full table-auto border-collapse">
            ...
            <TableHeader>
              <TableRow className="">
                <TableHead className="text-left px-4 py-2 text-gray-500 text-sm">Male</TableHead>
                <TableHead className="text-left px-4 py-2 text-gray-500 text-sm">Female</TableHead>
                <TableHead className="text-left px-4 py-2 text-gray-500 text-sm">Juvenile</TableHead>
              </TableRow>
            </TableHeader>
      ...
      <h2 className="text-sm font-medium text-gray-600 mb-3">Arrests by Category</h2>
